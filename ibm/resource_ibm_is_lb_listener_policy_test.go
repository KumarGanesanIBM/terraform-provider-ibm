...
}`, regionName, vpcname, subnetname, zone, cidr, lbname, port, protocol, action, priority, lblistenerpolicyname)
...
}`, regionName, vpcname, subnetname, zone, cidr, lbname, port, protocol, priority, lblistenerpolicyname)
